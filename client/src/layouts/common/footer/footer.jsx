  ...
  useEffect(() => {
    ...
    async function fetchCounts() {
      try {
        ...
        const [blogsResp, writersResp] = await Promise.all([
          getBlogs(),
          getWriters(),
        ]);
        ...
        const writersArray = Array.isArray(writersResp)
          ? writersResp
          : writersResp?.data || writersResp?.writers || [];

        if (!cancelled) {
          setBlogCount(Array.isArray(blogsArray) ? blogsArray.length : 0);
          setWriterCount(Array.isArray(writersArray) ? writersArray.length : 0);
        }
      } catch (err) {
        // ignore failures silently for footer; could add small fallback
      } finally {
        ...
        <div className="footer-sections">
          ...
          <div className="footer-section">
            <div className="footer-brand">
              <h3 className="footer-logo">📝 BlogPlatform</h3>
              <p className="footer-description">
                Share your stories with the world. A modern blogging platform
